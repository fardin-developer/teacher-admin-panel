      ...
      >
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            <h2 style={{ textAlign: "center",color:(message.status===200)?"#40ed40":"#c95757" }}> {message.message}</h2>
            <p style={{ textAlign: "center",color:(message.status===200)?"#40ed40":"#c95757" }}>{message.message1}</p>
